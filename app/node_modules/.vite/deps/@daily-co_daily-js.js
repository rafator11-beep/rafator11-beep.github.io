...
var y = function() {
  ...
  function c2(e3, t3, n3, r3) {
    var i3, o3, c3, l3;
    if (s2(n3), void 0 === (o3 = e3._events) ? (o3 = e3._events = /* @__PURE__ */ Object.create(null), e3._eventsCount = 0) : (void 0 !== o3.newListener && (e3.emit("newListener", t3, n3.listener ? n3.listener : n3), o3 = e3._events), c3 = o3[t3]), void 0 === c3)
      c3 = o3[t3] = n3, ++e3._eventsCount;
  ...
  return Object.defineProperty(i2, "defaultMaxListeners", { enumerable: true, get: function() {
    ...
    if ("number" != typeof e3 || e3 < 0 || r2(e3))
  ...
  if (e2 && t2 && (n2 = e2.constructor) === t2.constructor) {
    ...
    if (n2 === Set) {
      if (e2.size !== t2.size)
        return false;
      for (r2 of e2) {
        if ((i2 = r2) && "object" == typeof i2 && !(i2 = w(t2, i2)))
          return false;
        if (!t2.has(i2))
          return false;
      }
    ...
    if (n2 === Map) {
      if (e2.size !== t2.size)
        return false;
      for (r2 of e2) {
        if ((i2 = r2[0]) && "object" == typeof i2 && !(i2 = w(t2, i2)))
          return false;
        if (!S(r2[1], t2.get(i2)))
          return false;
      }
    ...
    if (!n2 || "object" == typeof e2) {
      for (n2 in r2 = 0, e2) {
        if (_.call(e2, n2) && ++r2 && !_.call(t2, n2))
          return false;
        if (!(n2 in t2) || !S(e2[n2], t2[n2]))
          return false;
      }
...
var L = class {
  ...
  compareVersion(e2) {
    ...
    if ("string" == typeof i2)
      return ">" === e2[0] || "<" === e2[0] ? (n2 = e2.substr(1), "=" === e2[1] ? (r2 = true, n2 = e2.substr(2)) : t2 = [], ">" === e2[0] ? t2.push(1) : t2.push(-1)) : "=" === e2[0] ? n2 = e2.substr(1) : "~" === e2[0] && (r2 = true, n2 = e2.substr(1)), t2.indexOf(O.compareVersions(i2, n2, r2)) > -1;
  }
  isOS(e2) {
...
function B(e2) {
  return null != e2 && e2.callObjectBundleUrlOverride ? e2.callObjectBundleUrlOverride : F("https://c.daily.co/call-machine/versioned/".concat("0.87.0", "/static/call-machine-object-bundle.js"), e2);
}
function U(e2) {
  try {
    new URL(e2);
...
function Oe(e2, t2 = {}) {
  ...
  try {
    ...
    for (; n2 && o2++ < r2 && (l2 = Pe(n2, u2), !("html" === l2 || o2 > 1 && s2 + i2.length * c2 + l2.length >= d2)); )
...
function Fe(e2) {
  if (ve(e2))
    return { message: e2.message, name: e2.name, stack: e2.stack, ...Ue(e2) };
  if (ke(e2)) {
...
function Je(e2, t2) {
  if (function(e3) {
    ...
    for (const n3 of Object.getOwnPropertyNames(e2))
      void 0 !== e2[n3] && (r2[n3] = Je(e2[n3], t2));
    return r2;
  }
  if (Array.isArray(e2)) {
    const n2 = t2.get(e2);
...
function ot(e2, t2, n2 = 2) {
  ...
  const r2 = { ...e2 };
  for (const e3 in t2)
    Object.prototype.hasOwnProperty.call(t2, e3) && (r2[e3] = ot(r2[e3], t2[e3], n2 - 1));
  return r2;
}
var st = "_sentrySpan";
function at(e2, t2) {
...
var lt = class _lt {
  ...
  captureException(e2, t2) {
    ...
    if (!this._client)
      return Q.warn("No client configured on scope - will not capture exception!"), n2;
  ...
  captureMessage(e2, t2, n2) {
    ...
    if (!this._client)
      return Q.warn("No client configured on scope - will not capture message!"), r2;
...
function Bt(e2) {
  ...
  if (t2 && function(e3) {
    ...
    return !(["protocol", "publicKey", "host", "projectId"].find((t4) => !e3[t4] && (Q.error(`Invalid Sentry Dsn: ${t4} missing`), true)) || (n2.match(/^\d+$/) ? function(e4) {
...
function Jt(e2, t2, n2 = 1 / 0, r2 = 1 / 0, i2 = function() {
  ...
  const a2 = function(e3, t3) {
    try {
      ...
      if (Ee(t3))
        return "[VueViewModel]";
      if (Se(n3 = t3) && "nativeEvent" in n3 && "preventDefault" in n3 && "stopPropagation" in n3)
        return "[SyntheticEvent]";
      if ("number" == typeof t3 && !Number.isFinite(t3))
        return `[${t3}]`;
      if ("function" == typeof t3)
        return `[Function: ${te(t3)}]`;
      if ("symbol" == typeof t3)
        return `[${String(t3)}]`;
      if ("bigint" == typeof t3)
...
function yn(e2, t2, n2) {
  if (n2[t2.name])
    V && Q.log(`Integration skipped because it was already installed: ${t2.name}`);
  else {
...
var wn = class {
  ...
  captureEvent(e2, t2, n2) {
    const r2 = ze();
    if (t2 && t2.originalException && Ke(t2.originalException))
      return V && Q.log(_n), r2;
  ...
  _processEvent(e2, t2, n2) {
    ...
    if (s2 && "number" == typeof l2 && Math.random() > l2)
      return this.recordDroppedEvent("sample_rate", "error", e2), Ze(new bn(`Discarding event because it's not included in the random sample (sampling rate = ${i2})`, "log"));
    ...
    return this._prepareEvent(e2, t2, n2, d2).then((n3) => {
      if (null === n3)
        throw this.recordDroppedEvent("event_processor", u2, e2), new bn("An event processor returned `null`, will not send event.", "log");
...
Reason: ${e3}`);
  ...
  _flushOutcomes() {
    ...
    if (0 === e2.length)
      return void (V && Q.log("No outcomes to send"));
    if (!this._dsn)
      return void (V && Q.log("No dsn provided, will not send outcomes"));
...
function Mn(e2) {
  ...
  return { $: t2, add: function(r2) {
    if (!(void 0 === e2 || t2.length < e2))
      return Ze(new bn("Not adding Promise because buffer limit was reached."));
    const i2 = r2();
...
function En(e2, t2, n2 = Mn(e2.bufferSize || 64)) {
  ...
  return { send: function(i2) {
    ...
    return n2.add(() => t2({ body: Ht(s2) }).then((e3) => (void 0 !== e3.statusCode && (e3.statusCode < 200 || e3.statusCode >= 300) && V && Q.warn(`Sentry responded with status code ${e3.statusCode} to sent event.`), r2 = Cn(r2, e3), e3), (e3) => {
      ...
      if (e3 instanceof bn)
        return V && Q.error("Skipped sending event because buffer is full."), a2("queue_overflow"), Xe({});
      throw e3;
    });
...
var Ln = (e2 = {}) => ({ name: "InboundFilters", processEvent(t2, n2, r2) {
  ...
  return function(e3, t3) {
    if (t3.ignoreInternal && function(e4) {
      ...
      return V && Q.warn(`Event dropped due to being internal Sentry Error.
Event: ${He(e3)}`), true;
    if (function(e4, t4) {
      ...
      return V && Q.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${He(e3)}`), true;
    if (function(e4) {
      if (e4.type)
        return false;
      ...
      return V && Q.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${He(e3)}`), true;
    if (function(e4, t4) {
      ...
      return V && Q.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${He(e3)}`), true;
    if (function(e4, t4) {
      if (!t4 || !t4.length)
        return false;
      ...
      return V && Q.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${He(e3)}.
Url: ${Dn(e3)}`), true;
    if (!function(e4, t4) {
      if (!t4 || !t4.length)
      ...
      return V && Q.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${He(e3)}.
Url: ${Dn(e3)}`), true;
    return false;
  }(t2, o2) ? null : t2;
...
function Nn(e2, t2, n2 = 250, r2, i2, o2, s2) {
  if (!(o2.exception && o2.exception.values && s2 && Ce(s2.originalException, Error)))
    return;
  ...
  return { name: "Dedupe", processEvent(t2) {
    ...
    try {
      if (function(e3, t3) {
        ...
        return V && Q.warn("Event dropped due to being a duplicate of previously captured event."), null;
    } catch (e3) {
    }
    return e2 = t2;
  } };
...
function ar(e2, t2, n2, r2) {
  ...
  if (s2)
    return { exception: { values: [sr(e2, s2)] }, extra: a2 };
...
function gr(e2, { isUnhandledRejection: t2 }) {
  const n2 = function(e3, t3 = 40) {
    ...
    for (let e4 = n3.length; e4 > 0; e4--) {
      ...
      if (!(r4.length > t3))
        return e4 === n3.length ? r4 : Ae(r4, t3);
    }
    return "";
...
var mr = class extends wn {
  ...
  captureUserFeedback(e2) {
    if (!this._isEnabled())
      return void (or && Q.warn("SDK not enabled, will not capture user feedback."));
    const t2 = function(e3, { metadata: t3, tunnel: n2, dsn: r2 }) {
      const i2 = { event_id: e3.event_id, sent_at: (/* @__PURE__ */ new Date()).toISOString(), ...t3 && t3.sdk && { sdk: { name: t3.sdk.name, version: t3.sdk.version } }, ...!!n2 && !!r2 && { dsn: Rt(r2) } }, o2 = function(e4) {
  ...
  return (n2) => {
    ...
    if (!function(e3) {
      if (e3.type !== wr)
        return false;
      try {
        if (!e3.target || e3.target._sentryId !== Sr)
          return false;
      } catch (e4) {
      }
      return true;
...
function Tr() {
  ...
  br.onpopstate = function(...t3) {
    ...
    kr = n2;
    if (ae("history", { from: r2, to: n2 }), e2)
      try {
...
function Ir(e2, t2 = function(e3) {
  ...
  return En(e2, function(i2) {
    ...
    if (!t2)
      return Pr("fetch"), Ze("No fetch implementation available");
    try {
...
var Zr = () => ({ name: "HttpContext", preprocessEvent(e2) {
  if (!tr.navigator && !tr.location && !tr.document)
    return;
...
var Ds = function() {
  ...
  return o(e2, [{ key: "isNoOp", value: function() {
    ...
    if (!Ls.includes(e3))
      throw Error("Unrecognized mergeStrategy provided. Options are: [".concat(Ls, "]"));
    ...
    if (r2.length > qo)
      throw Error("Meeting session data is too large (".concat(r2.length, " characters). Maximum size suppported is ").concat(qo, "."));
  } }]);
}();
function Ns() {
  try {
...
var zs = function() {
  return o(function e3(n3, r3, i3) {
    ...
    try {
      ...
      if (clearTimeout(this._networkTimeout), t3 instanceof Js || this.cancelled || this._networkTimedOut)
        return;
...
var Ca = function() {
  ...
  return o(e2, [{ key: "clone", value: function() {
    var t2 = new e2();
    if (this.base instanceof Ea ? t2.base = this.base.clone() : t2.base = this.base, void 0 !== this.byUserId)
    ...
    var e3 = {};
    if ("boolean" == typeof this.base ? e3.base = this.base : this.base instanceof Ea && (e3.base = this.base.toJSONObject()), void 0 !== this.byUserId)
    ...
    var n2, r2, i2;
    if (void 0 !== t2.base && (n2 = "boolean" == typeof t2.base ? t2.base : Ea.fromJSONObject(t2.base)), void 0 !== t2.byUserId)
    ...
    var n2, r2, i2;
    if (void 0 !== t2.b && (n2 = "boolean" == typeof t2.b ? t2.b : Ea.fromMinifiedJSONObject(t2.b)), void 0 !== t2.u)
...
var za = { customIntegrations: { validate: gc, help: fc() }, customTrayButtons: { validate: vc, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify($a)) }, url: { validate: function(e2) {
  ...
  if (e2 instanceof MediaStreamTrack)
    t2._sharedTracks.videoTrack = e2, n2 = { customTrack: Qo };
  else {
  ...
  var n2;
  if (e2 instanceof MediaStreamTrack)
    t2._sharedTracks.audioTrack = e2, n2 = { customTrack: Qo };
  else {
...
var Wa = { styles: { validate: function(e2) {
  ...
  if (n2.includes(e2) || !is() && "avatar" === e2)
    return true;
...
var Ha = function() {
  ...
  return l(r2, b), o(r2, [{ key: "destroy", value: (ee2 = p(function* () {
    ...
    for (var n2 in t2) {
      ...
      if (Wa[n2].validate && !Wa[n2].validate(t2[n2], this, this._participants[e2]))
        throw new Error(Wa[n2].help);
    }
    ...
    if (tc(this._callObjectMode, "updateWaitingParticipant()"), Ka(this._callState, "updateWaitingParticipant()"), "string" != typeof t2 || "object" !== n(r3))
    ...
    if (tc(this._callObjectMode, "updateWaitingParticipants()"), Ka(this._callState, "updateWaitingParticipants()"), "object" !== n(t2))
    ...
    if (tc(this._callObjectMode, "getReceiveSettings()"), !this._callMachineInitialized)
    ...
    var t2 = this;
    if (tc(this._callObjectMode, "updateReceiveSettings()"), !sc(e2, { allowAllParticipantsKey: true }))
      throw new Error(hc({ allowAllParticipantsKey: true }));
    ...
    if (e2.video) {
      ...
      if (r3.video = {}, e2.video.settings)
        r3.video.settings = {}, t2 || e2.video.settings.customTrack || null === (s2 = n2.video) || void 0 === s2 || !s2.settings ? r3.video.settings = e2.video.settings : r3.video.settings = Aa(Aa({}, n2.video.settings), e2.video.settings), Object.keys(r3.video.settings).length || delete r3.video.settings;
      else
    ...
    if (e2.audio) {
      ...
      if (r3.audio = {}, e2.audio.settings)
        r3.audio.settings = {}, t2 || e2.audio.settings.customTrack || null === (l2 = n2.audio) || void 0 === l2 || !l2.settings ? r3.audio.settings = e2.audio.settings : r3.audio.settings = Aa(Aa({}, n2.audio.settings), e2.audio.settings), Object.keys(r3.audio.settings).length || delete r3.audio.settings;
      else
    ...
    if (rc(), this._callMachineInitialized)
    ...
    var t2 = this;
    if ("undefined" == typeof AudioWorkletNode && !is())
    ...
    var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    if (tc(this._callObjectMode, "startCamera()"), Xa(this._callState, this._isPreparingToJoin, "startCamera()", "Did you mean to use setLocalAudio() and/or setLocalVideo() instead?"), this.needsLoad())
      try {
        yield this.load(t2);
      } catch (e3) {
    ...
    if (rc(), void 0 !== i3 && (n2 = i3), void 0 !== o2 && (r3 = o2), "boolean" == typeof n2 && (this._setAllowLocalAudio(n2), n2 = void 0), "boolean" == typeof r3 && (this._setAllowLocalVideo(r3), r3 = void 0), !n2 && !r3)
    ...
    if (rc(), !n2 || "string" != typeof n2)
      throw new Error("outputDeviceId must be provided and must be a valid device id");
    ...
    if (ic(), [Da, Na].includes(e2)) {
      if (e2 !== this._nativeInCallAudioMode)
        return this._nativeInCallAudioMode = e2, !this.disableReactNativeAutoDeviceManagement("audio") && Ya(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
    } else
      console.error("invalid in-call audio mode specified: ", e2);
  } }, { key: "preAuth", value: (U2 = p(function* () {
    var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    if (tc(this._callObjectMode, "preAuth()"), Xa(this._callState, this._isPreparingToJoin, "preAuth()"), this.needsLoad() && (yield this.load(t2)), !t2.url)
    ...
    if (this.needsLoad()) {
      ...
      if (e2 && (this.validateProperties(e2), this.properties = Aa(Aa({}, this.properties), e2)), !this._callObjectMode && !this.properties.url)
    ...
    return void 0 !== t2.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t2.showLocalVideo), void 0 !== t2.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t2.showParticipantsBar), this._callState === oi || this._callState === ii ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(false)) : (this._updateCallState(ii, false), this.emitDailyJSEvent({ action: Wi }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, false), this.sendMessageToCallMachine({ action: "join-meeting", properties: Qa(this.properties, this.callClientId), preloadCache: Qa(this._preloadCache, this.callClientId) }, function(t3) {
      ...
      e2._joinedCallback = function(i3, o2) {
        if (e2._callState !== ai) {
          if (o2)
            return e2._updateCallState(si), void n3(o2);
          if (e2._updateCallState(oi), i3)
            for (var s2 in i3) {
    ...
    if (Za(this._callMachineInitialized, "startScreenShare()"), t2.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t2.screenVideoSendSettings), t2.mediaStream && (this._sharedTracks.screenMediaStream = t2.mediaStream, t2.mediaStream = Qo), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
      ...
      if (yield n2.isScreenBeingCaptured())
        return void this.emitDailyJSEvent({ action: Vo, type: "screen-share-error", errorMsg: "Could not start the screen sharing. The screen is already been captured!" });
      ...
      this.sendMessageToCallMachine({ action: Wo, captureOptions: t2 });
  }), function() {
    return I2.apply(this, arguments);
    ...
    if (t2 && "cloud" !== t2 && "cloud-audio-only" !== t2 && "raw-tracks" !== t2 && "local" !== t2)
      throw new Error("invalid type: ".concat(t2, ", allowed values 'cloud', 'cloud-audio-only', 'raw-tracks', or 'local'"));
      ...
      for (var r3 = 0; r3 < e2.length; r3++) {
        ...
        for (var o2 in this._validateEncodingLayerHasValidProperties(i3), i3)
          if (Ua.includes(o2)) {
            ...
            throw new Error("Invalid key ".concat(o2, ", valid keys are:") + Object.values(Ua));
    ...
    try {
      !function(e3) {
        ...
        for (var t3 in e3)
          if (!Va.includes(t3))
            throw new Error("Invalid key ".concat(t3, ", valid keys are: ").concat(Va));
    ...
    if (Ka(this._callState, "updateTranscription()"), !e2)
    ...
    if (Ka(this._callState, "stopTranscription()"), e2 && "object" !== n(e2))
    ...
    if (e2.provider) {
      if ("daily" !== e2.provider)
        throw new Error("Error: provider can be set only to 'daily', got: ".concat(e2.provider));
      if (e2.phoneNumber)
        throw new Error("Error starting dial out: provider valid only for sipUri, not phoneNumber");
    ...
    var t2 = this;
    if (Ka(this._callState, "sipCallTransfer()"), !e2)
    ...
    var t2 = this;
    if (Ka(this._callState, "sipRefer()"), !e2)
    ...
    var e2 = this;
    if (ec(this._testCallInProgress, "testWebsocketConnectivity()"), this.needsLoad())
      try {
        yield this.load();
      } catch (e3) {
        return Promise.reject(e3);
    ...
    var t2 = this;
    if (ec(this._testCallInProgress, "testPeerToPeerCallQuality()"), this.needsLoad())
      try {
        yield this.load();
      } catch (e3) {
        return Promise.reject(e3);
    ...
    var t2 = this;
    if (ec(this._testCallInProgress, "testNetworkConnectivity()"), this.needsLoad())
      try {
        yield this.load();
      } catch (e3) {
        return Promise.reject(e3);
    ...
    if (!((null === (t2 = Object.keys(e2)) || void 0 === t2 ? void 0 : t2.length) > 0))
      throw new Error("Empty encoding is not allowed. At least one of these valid keys should be specified:" + Object.values(Ua));
    ...
    var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "*";
    if (Ka(this._callState, "sendAppMessage()"), JSON.stringify(e2).length > this._maxAppMessageSize)
    ...
    if (rc(), this._iframe && !document.fullscreenElement && as())
      try {
    ...
    if (rc(), "number" != typeof e2 && true !== e2 && false !== e2)
    ...
    for (var l2 in e2)
      if (za[l2]) {
        if (za[l2].validate && !za[l2].validate(e2[l2], this))
          throw new Error("property '".concat(l2, "': ").concat(za[l2].help));
      } else
        console.warn("Ignoring unrecognized property '".concat(l2, "'")), delete e2[l2];
    ...
    if (null !== (t2 = e2.error) && void 0 !== t2 && t2.type) {
      if (![Pi, Ti, Ci].includes(e2.error.type))
        return;
      if (e2.error.type === Ci && e2.error.msg.includes("deleted"))
        return;
    }
    ...
    var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    if (rc(), !e2 || !e2.contentWindow || "string" != typeof e2.src)
    ...
    window.navigator && window.navigator.userAgent.match(/Chrome\/61\./) ? s2.allow = "microphone, camera" : s2.allow = "microphone; camera; autoplay; display-capture; screen-wake-lock; compute-pressure;", s2.style.visibility = "hidden", n2.appendChild(s2), s2.style.visibility = null, Object.keys(o2).forEach(function(e3) {
...
function Ga(e2) {
  if (e2.extension) {
    if ("string" != typeof e2.extension)
      throw new Error("Error starting dial out: extension must be a string");
    if (e2.extension.length > 20)
      throw new Error("Error starting dial out: extension length must be less than or equal to 20");
  }
  if (e2.waitBeforeExtensionDialSec) {
    if ("number" != typeof e2.waitBeforeExtensionDialSec)
      throw new Error("Error starting dial out: waitBeforeExtensionDialSec must be a number");
    if (e2.waitBeforeExtensionDialSec > 60)
      throw new Error("Error starting dial out: waitBeforeExtensionDialSec must be less than or equal to 60");
    if (!e2.extension)
      throw new Error("Error starting dial out: waitBeforeExtensionDialSec requires a phoneNumber and extension");
  }
}
function Qa(e2, t2) {
  var n2 = {};
  for (var r2 in e2)
    if (e2[r2] instanceof MediaStreamTrack)
      console.warn("MediaStreamTrack found in props or cache.", r2), n2[r2] = Qo;
...
function lc(e2) {
  ...
  return !!e2 && ("object" === n(e2) && (Object.keys(e2).filter(function(e3) {
    ...
    if ("string" != typeof e3)
      return false;
    if (!Object.values(Yo).includes(e3))
...
function uc(e2) {
  ...
  if (!function(e3) {
    if ("string" != typeof e3)
      return false;
    if (!Object.values(Ko).includes(e3))
...
function vc(e2) {
  if (e2 && "object" !== n(e2) || Array.isArray(e2))
    return console.error("customTrayButtons should be an Object of the type ".concat(JSON.stringify($a), ".")), false;
  if (e2)
    for (var t2 = 0, r2 = Object.entries(e2); t2 < r2.length; t2++)
...
function bc(e2) {
  ...
  if (e2.state && !Object.values(Xo).includes(e2.state))
    throw new Error("Invalid value for RemoteMediaPlayerSettings.state, valid values are: " + JSON.stringify(Xo));
  if (e2.volume) {
