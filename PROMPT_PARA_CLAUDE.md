...
Es largo pero Claude necesita todo este contexto para no inventar formatos incorrectos.
...
export const cadenaNuevo: string[] = [
  "🔗 CADENA: Por turnos, decid nombres de programas de TV que ya no existan. El que repita o falle bebe 3. 🍻",
  // ...
];
```
...
1. **Mensaje 1**: Pega todo el bloque → Claude dará código + criterios + Bloque 1
