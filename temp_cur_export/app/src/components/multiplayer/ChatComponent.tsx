            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-64 right-6 w-80 h-96 bg-black/95 backdrop-blur-md rounded-2xl border border-primary/20 shadow-2xl z-40 flex flex-col overflow-hidden"
                    >
                        {/* Header */}
