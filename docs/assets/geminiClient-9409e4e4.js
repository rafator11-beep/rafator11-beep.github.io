...
Reto original: "${o}"
Jugadores implicados en este reto: ${s.join(", ")}
...
No devuelvas nada más que el objeto JSON.
`,a=await d(r);return(a==null?void 0:a.announcement)||null}async function h(o,e,s,n){const r=`
...
No devuelvas nada más que el objeto JSON.
`,a=await d(r);return(a==null?void 0:a.comment)||null}async function j(o,e){const s=getPartyTheme(),r=`
...
No devuelvas nada más que el objeto JSON.
`,a=await d(r);return(a==null?void 0:a.chronicle)||null}async function S(o,e){const s=`
...
No devuelvas nada más que el objeto JSON.
`,n=await d(s);return(n==null?void 0:n.ruling)||null}async function N(o,e){const s=getPartyTheme(),n=s?` El castigo debe estar inspirado en el tema especial de la fiesta: "${s}".`:"",r=`
