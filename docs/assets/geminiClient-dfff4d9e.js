...
`,r=await i(n);return(r==null?void 0:r.card)||null}async function q(o,e,s,a){const n=m(),r=n?`
...
No devuelvas nada más que el objeto JSON.
`,r=await i(n);return(r==null?void 0:r.chronicle)||null}async function A(o,e){const s=`
...
No devuelvas nada más que el objeto JSON.
`,a=await i(s);return(a==null?void 0:a.ruling)||null}async function P(o,e){const s=m(),a=s?` El castigo debe estar inspirado en el tema especial de la fiesta: "${s}".`:"",n=`
...
No devuelvas nada más que el objeto JSON.
`,a=await i(s);return a&&a.category&&a.word&&a.fakeWord&&a.hint?a:null}async function T(o,e){const s=`
...
No devuelvas nada más que el objeto JSON.
`,a=await i(s);return(a==null?void 0:a.coachAnalysis)||null}async function x(o){const e=`
...
`;return await i(e)||null}export{q as geminiEnrichChallenge,N as geminiGenerateCard,P as geminiGenerateCustomPunishment,J as geminiGenerateImpostorRound,I as geminiGeneratePartyChronicle,T as geminiGenerateProfileCoach,$ as geminiGenerateRoundAnalysis,x as geminiGenerateSecretsTrivia,O as geminiGenerateTorneoAnnouncement,A as geminiResolveDispute,v as getGeminiApiKey,m as getPartyTheme,S as isGeminiConfigured};
